...
{
    /*输入量P语言值特征点*/
    float EFF[7]={-21,-14,-7,0,7,14,21};//-21,-14,-7,0,7,14,21
    /*输入量D语言值特征点*/
    float DFF[7]={-12,-7,-3,0,3,7,12};////-8,-5,-2,0,2,5,8
    /*输出量U语言值特征点(根据赛道类型选择不同的输出值)*/
    float UFF[7]={0,4,9,15,23,31,40};//0,4,9,15,23,31,40
...
float Fuzzy_D(float E,float EC)
{
    ...
    float EFF[7]={-21,-14,-7,0,7,14,21};//-21,-14,-7,0,7,14,21
    /*输入量D语言值特征点*/
    float DFF[7]={-12,-7,-3,0,3,7,12};//-12,-7,-3,0,3,7,12
    /*输出量U语言值特征点(根据赛道类型选择不同的输出值)*/
    float UFF[7]={0,4,8,12,18,26,36};//0,4,8,12,18,26,36
